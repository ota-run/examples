...
A copyable starting point for a Node service that runs setup and tests in a remote execution context through ota. It is useful when you want one shared execution target instead of every developer rebuilding the same environment by hand.
